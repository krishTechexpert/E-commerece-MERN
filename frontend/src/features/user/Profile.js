                ...
                <div className='flex'>
                    <div className='w-60 pt-5'>
                        <img
                            ...
                            src={user && user.avatar?.url?user.avatar?.url:photo}
                            alt={user.name}
                        />
                    </div>
                    <div className='pl-20 w-9/12'>
                        ...
                        <div className="grid gap-4 grid-cols-2 mt-8">
                            ...
                            <div className='mb-2 w-1/2'>
                                ...
                                <h2 className='text-base text-[#333]'>{user?.gender}</h2>
                            </div>
                            <div className='mb-2 w-1/2'>
                            ...
                            <div className='mb-2 w-1/2'>
                               <Link to="/password/update" className='text-base text-[#3063ec]'>Change Password</Link>
                            </div>
                            <div className='mb-2 w-1/2'>
                                <label htmlFor="name" className="text-base font-medium text-gray-900">
                                    Account open 
                        ...
                        <div className='mt-4'>
                                ...
                                <input id="link-checkbox" type="checkbox" checked={user.acceptConditions} readOnly  className="w-4 h-4 mr-2 text-blue-600 bg-gray-100 border-gray-300 rounded   dark:bg-gray-700 dark:border-gray-600" />
                                    Company Terms and Condition Accepted
                                </label>
                            </div>
                    </div>
                </div>
