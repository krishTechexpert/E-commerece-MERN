...
function Home() {
    ...
    <MetaData title = "Big Bazaar | Home" />
      ...
      <div className="relative">
        <img
          ...
          alt=""
        />
        <button className='hover:transition-all bg-white opacity-75 text-2xl px-5 py-5 w-80 h-20 absolute top-0 bottom-0 left-0 right-0 m-auto flex justify-center align-center'>
        <ReactTyped
  strings={["Search for Mobile", "Search for Laptop", "Search for Watches"]}
  typeSpeed={50}
  backSpeed={50}
  backDelay={1}
  loop
  smartBackspace
/>
           {/* <ArrowDownCircle className="animate-bounce w-6 h-6 mx-4 mt-3 text-blue-700" /> */}
        </button>
      </div>
